...
export default async function AnalyticsPage() {
  const data = await getAnalytics().catch(() => ({ total_finalized_attempts: 0, total_active_seconds: 0, average_attempt_seconds: null, bands: { READING: { latest: null, best: null, average: null }, LISTENING: { latest: null, best: null, average: null }, WRITING: { latest: null, best: null, average: null } }, completed_full_mocks: 0, latest_project_overall: null, latest_full_mock: null, trends: [], question_types: [], weak_areas: [], attempts: [], content_timing: [] }));
