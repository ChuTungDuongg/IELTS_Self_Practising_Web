...
import { questionTypeLabel } from "./question-type-meta";
...
const definitions: QuestionTypeDefinition[] = [
  {
    id: "multiple_choice", label: questionTypeLabel("multiple_choice"), category: "shared",
  ...
  {
    id: "multiple_choice_multiple", label: questionTypeLabel("multiple_choice_multiple"), category: "shared",
  ...
  {
    id: "true_false_not_given", label: questionTypeLabel("true_false_not_given"), category: "reading",
  ...
  {
    id: "yes_no_not_given", label: questionTypeLabel("yes_no_not_given"), category: "reading",
  ...
  {
    id: "text_completion", label: questionTypeLabel("text_completion"), category: "shared",
  ...
  {
    id: "matching_headings", label: questionTypeLabel("matching_headings"), category: "reading",
  ...
  {
    id: "matching", label: questionTypeLabel("matching"), category: "shared",
  ...
  {
    id: "matching_information", label: questionTypeLabel("matching_information"), category: "reading",
  ...
  ...([[
    "matching_features", "Match each statement with the correct person, place, or category."
  ], [
    "matching_sentence_endings", "Choose the correct ending for each sentence beginning."
  ]] as const).map(([id, intro]) => ({
    id, label: questionTypeLabel(id), category: "reading" as const,
    BuilderEditor: MatchingEditor, AnswerKeyEditor: MatchingEditor, ExamRenderer: MatchingRenderer, ReviewRenderer: MatchingRenderer,
  ...
  {
    id: "summary_completion_word_list", label: questionTypeLabel("summary_completion_word_list"), category: "reading",
...
for (const id of ["plan_labelling", "map_labelling"] as const) {
...
definitions.push({
  ...
  label: questionTypeLabel("diagram_labelling"),
  category: "shared",
...
definitions.push({
  id: "table_completion",
  label: questionTypeLabel("table_completion"),
  category: "shared",
...
definitions.push({
  id: "note_completion",
  label: questionTypeLabel("note_completion"),
  category: "shared",
...
for (const [id, kind] of [["form_completion", "FORM"], ["flow_chart_completion", "FLOW_CHART"], ["summary_completion", "SUMMARY"], ["sentence_completion", "SENTENCE"]] as const) {
  const label = questionTypeLabel(id);
  definitions.push({
...
definitions.push({
  id: "short_answer", label: questionTypeLabel("short_answer"), category: "shared", BuilderEditor: TextCompletionEditor, AnswerKeyEditor: TextCompletionEditor, ExamRenderer: TextCompletionRenderer, ReviewRenderer: TextCompletionRenderer,
